...
const AddSongDialog = ({ className }: AddSongDialogProps) => {
  ...
  return (
    <Dialog open={songDialogOpen} onOpenChange={setSongDialogOpen}>
      ...
      <DialogContent
        className={`bg-zinc-900 border-zinc-700 max-w-full sm:max-w-lg mx-4 sm:mx-auto max-h-[80vh] overflow-auto p-4 sm:p-6 ${className}`}
      >
        <DialogHeader>
